...
export default (props) => {
    ...
    return (
        <div className="Menu">
            ...
            {adventure1Done == false ? <Button m={10} onClick={() => navigate("/maze")} variant="contained" >Adventure 1</Button> : <Button m={10} disabled>Adventure 1</Button> }
            <Button m={10} onClick={() => navigate("/maze")} variant="contained" >Adventure 2</Button> 
